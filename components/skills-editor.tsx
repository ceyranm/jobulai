...
export default function SkillsEditor({ skills, profileId }: SkillsEditorProps) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      // candidate_info tablosunda becerileri güncelle
      ...
      setError(err.message || 'Beceriler güncellenirken hata oluştu');
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
              ...
              {success && (
                <div className="mb-4 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg text-sm">
                  ✅ Beceriler başarıyla güncellendi!
                </div>
              )}
